...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        H1 appName = new H1("Transaction Accounts");
    ...
    private AppNav createNavigation() {
        ...
        nav.addItem(new AppNavItem("Account Types", AccountTypesView.class, LineAwesomeIcon.COG_SOLID.create()));
        nav.addItem(new AppNavItem("Accounts", AccountsView.class, LineAwesomeIcon.COINS_SOLID.create()));
